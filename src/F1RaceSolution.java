...
public class F1RaceSolution {
    ...
    public static String exercise1_StartYourEngines() {
        // Define an array of race locations
        String[] raceLocations = {"Monaco", "Silverstone", "Suzuka", "Spa", "Hungary", "Imola", "Austin", "Bahrain", "Singapore", "Melbourne"};

        // Generate a random index between 0 and the length of the array - 1
        Random random = new Random();
        int randomIndex = random.nextInt(raceLocations.length);

        // Return the randomly selected race location
        return raceLocations[randomIndex];
    }
    ...
    public static String[] exercise2_RaceReport() {
        // Define an array with six driver names
        String[] raceDrivers = {"Hamilton", "Verstappen", "Leclerc", "Norris", "Russell", "Sainz"};
    ...
    public static String exercise3_GetLastDriver(String[] drivers) {
        String lastDriver = drivers[drivers.length - 1];
    ...
    public static void exercise6_DisplayDriverPositions(String[] drivers) {
        ...
        for (int i = 0; i < drivers.length; i++) {
            System.out.println("Position " + (i + 1) + ": " + drivers[i]); // Print position and driver name
        }
    }
    ...
    public static void exercise7_DriverChange(String[] drivers) {
        ...
        if (index >= 0 && index < drivers.length) { // Validate index
            drivers[index] = newDriver; // Replace driver at given index
        } else {
    ...
    public static void exercise8_ReverseDriverList(String[] drivers) {
        ...
        for (int i = drivers.length - 1; i >= 0; i--) {
            System.out.println(drivers[i]); // Print each driver in reverse order
        }
    }
    ...
    public static void exercise10_PitStop(String[] originalDrivers) {
        ...
        System.arraycopy(originalDrivers, 0, copiedDrivers, 0, originalDrivers.length);
